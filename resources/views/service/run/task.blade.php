...
@section('run-application-content')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="data-job-insert-form">
                        ...
                        <div class="input-group input-group-sm mb-3">
                            <span class="input-group-text" id="inputGroup-sizing-sm">Ref. No.</span>
                        ...
                        <input type="hidden" name="operation_mode" value="2">
                    </form>
                </div>
    ...
    <script type="text/javascript">
        ...
        function getDataJob() {
            ...
            const data_job_ajax_url = "{!!route('data_set_job.index',['operationMode'=>2,'serviceVersionId'=>$serviceVersionId])!!}";
