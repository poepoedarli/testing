    ...
    <div class="">
        <div class="block block-rounded">
            <div class="block-header bg-body-light">
                <h3 class="block-title text-primary"><i class="fa fa-square-plus me-2"></i>Create Dataset</h3>
            </div>
            <div class="block-content">
                @component('components.error')
                    <!-- show error messages  -->
                @endcomponent
                {!! Form::open(['route' => 'datasets.store', 'files' => true, 'method' => 'POST', 'class' => 'mx-4']) !!}
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 mt-2">
                        <div class="form-group">
                            ...
                            {!! Form::text('data_path', null, ['placeholder' => 'URL', 'class' => 'form-control']) !!}
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 mt-2">
                        <span class="text-warning fw-bold">(OR)</span>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 mt-2">
                        <div class="form-group">
                            <strong data-bs-toggle="tooltip" data-bs-placement="top"
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 mt-2">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="descriptions" id="descriptions" rows="10"></textarea>
