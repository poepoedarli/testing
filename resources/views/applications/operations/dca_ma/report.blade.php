                                ...
                                <div class="block-content block-content-full bg-body-light">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <img alt="" class="img-fluid" id="ref{{ $value['id'] }}"
                                        ...
                                        <div class="col-md-8 col-sm-12">
                                            ...
                                            <div>
                                                <a class="btn w-100 btn-alt-secondary"
                                                    href="{{ route('dca_ma.manual_labelling', [$application->id, $parameters['task']->id, $value['id']]) }}">
...
<script type="text/javascript">
    ...
    function loadPieChart() {
        ...
        window.activeCharts['dca_ma_report_chart'] = reportChart
