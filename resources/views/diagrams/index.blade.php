    ...
    <div id="allSampleContent" class="p-2 w-full">
        <div id="sample">
            ...
            <div style="width: 100%; display: flex; justify-content: space-between">
                ...
                <div id="myDiagramDiv"
                    style="flex-grow: 1; height: 750px; background-color: #ffffff; position: relative; -webkit-tap-highlight-color: rgba(255, 255, 255, 0); cursor: auto; border-left: 1px solid #e3e3e3">
